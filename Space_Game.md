...
1. Digite seu **nickname** e clique em **Jogar**.  
2. Use as **setas ← e →** para mover a nave.  
3. **Clique com o mouse** para atirar.  
4. Pressione **"P"** para **pausar** o jogo.  
5. Derrote os inimigos e **aumente sua pontuação**!  
...
Atirar	🖱️ clique do botão direito do mouse
...
🧑‍💻 Autor
Desenvolvido por [Renan Tertuliano Straquicini]
💬 Projeto feito para estudos de desenvolvimento web.
📧 Contato: [a14642@oficina.pt]
